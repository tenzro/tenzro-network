...
| [`docs/AI.md`](docs/AI.md) | Tenzro AI — decentralized inference (single-replica + sharded MoE + MTP + multi-modal), Cortex reasoning, confidential inference, and Tenzro Train (data-parallel, decoupled outer synchronization) training |
