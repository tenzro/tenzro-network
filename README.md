...
- **Forecast** (Chronos-2, Chronos-Bolt small/base, TimesFM 2.5 200M, Granite-TTM-r2): `tenzro_forecast`, `tenzro_listForecastCatalog`, `tenzro_loadForecastModel`, CLI `tenzro forecast`
