...
Tenzro Ledger is a multi-VM network supporting EVM (revm), SVM (solana_rbpf), and DAML (Canton 3.5+). This document describes the implemented architecture for cross-VM token interoperability based on the Sei V2 pointer model.
