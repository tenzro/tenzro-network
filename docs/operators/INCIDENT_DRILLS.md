...
```bash
gcloud compute ssh tenzro-validator-0 --zone=us-central1-a --project=tenzro-infra \
...
```bash
gcloud compute ssh tenzro-validator-<n> --zone=<zone> --project=tenzro-infra \
...
gcloud compute disks resize tenzro-validator-<n>-data \
  --zone=<zone> --project=tenzro-infra --size=<new-size-GB>
gcloud compute ssh tenzro-validator-<n> --zone=<zone> --project=tenzro-infra \
