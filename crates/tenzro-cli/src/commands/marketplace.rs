...
pub enum MarketplaceCommand {
    ...
    /// (charges the payer wallet for paid templates: marketplace commission -> treasury, remainder -> creator)
    Run(RunTemplateCmd),
}
...
///   - the governance-set marketplace commission flows to the network treasury
