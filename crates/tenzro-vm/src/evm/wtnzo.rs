...
pub const WTNZO_ADDRESS: [u8; 20] = [
    0x7a, 0x4b, 0xcb, 0x13, 0xa6, 0xb2, 0xb3, 0x84, 0xc2, 0x84, 0xb5, 0xca, 0xa6, 0xe5, 0xef, 0x31,
    0x26, 0x52, 0x7f, 0x93,
];
...
mod tests {
    ...
    fn test_create2_address_uses_correct_inputs() {
        ...
        let clone_prefix: &[u8] = &[
            0x3d, 0x60, 0x2d, 0x80, 0x60, 0x0a, 0x3d, 0x39, 0x81, 0xf3, 0x36, 0x3d, 0x3d, 0x37,
            0x3d, 0x3d, 0x3d, 0x36, 0x3d, 0x73,
        ];
        let clone_suffix: &[u8] = &[
