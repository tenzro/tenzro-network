...
/// Errors that can occur in the storage market.
#[derive(Error, Debug)]
...
impl From<tenzro_iroh::IrohError> for StorageMarketError {
    fn from(err: tenzro_iroh::IrohError) -> Self {
        Self::Transport(err.to_string())
    }
}

impl From<tenzro_settlement::SettlementError> for StorageMarketError {
