...
#
# Runs against https://rpc.tenzro.network (public RPC) and https://api.tenzro.network.
...
API=${API:-https://api.tenzro.network}
MCP=${MCP:-https://mcp.tenzro.network/mcp}
A2A=${A2A:-https://a2a.tenzro.network}
CANTON_MCP=${CANTON_MCP:-https://canton-mcp.tenzro.network/mcp}
